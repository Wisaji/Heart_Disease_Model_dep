...
#loaded_model = pickle.load(open('https://github.com/Wisaji/Heart_Disease_Model_dep/blob/main/naive_model_trained.sav', 'rb')) 

#import pickle

# LOADING THE MODEL FROM  GITHUB
# URL of the .sav file
url = 'https://github.com/Wisaji/Heart_Disease_Model_dep/blob/main/naive_model_trained.sav'

# Download the file
loaded_model = requests.get(url)

# Save the downloaded content to a temporary file
with open('naive_model_trained.sav', 'wb') as f:
    pickle.dump(loaded_model, f)


# Load the saved model
with open('naive_model_trained.sav', 'rb') as f:
